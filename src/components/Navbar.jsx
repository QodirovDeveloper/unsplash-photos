    ...
    <div className="fixed top-0 min-[973px]:left-[62px]  z-99999 left-0 right-0 backdrop-blur">
      <div className="min-[973px]:hidden pt-4 px-7 flex items-center justify-between">
        <div className="flex items-center gap-1">
          ...
          <div className="dropdown">
            <div tabIndex={0} role="button" className="flex items-center p-2 gap-1 cursor-pointer">
              <div>Photos</div>
              <FaAngleDown />
            </div>
            <ul tabIndex={0} className="dropdown-content menu bg-base-100 shadow-2xl border border-black/30 rounded-box z-1 w-52 p-2">
              <li><a>Photos</a></li>
        ...
        <div className="flex items-center justify-center gap-7">
          <div className="dropdown dropdown-end pb-1">
            <div tabIndex={0} role="button">
              <div className="tooltip tooltip-bottom hover:tooltip-open" data-tip="Notifications">
                <button className="text-2xl"><GoBell /></button>
              </div>
            </div>
            <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-1 w-62 h-50 p-2 shadow-2xl border border-black/30">
              <div role="tablist" className="tabs *:p-1 tabs-border">
                <a role="tab">Highlights</a>
                <a role="tab">Activity</a>
                <p className="p-10">Activity associated with your account will appear here.</p>
              </div>
            </ul>
          </div>
          ...
          <div className="dropdown dropdown-end pb-1">
            <div tabIndex={0} role="button">
              <div className="tooltip tooltip-bottom hover:tooltip-open" data-tip="Profile">
                <button className="text-2xl"><FaRegUserCircle /></button>
              </div>
            </div>
            <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-1 w-62 h-[340px] shadow-2xl border border-black/30">
              <li>
          ...
          <div className="dropdown dropdown-end pb-1">
            <div tabIndex={0} role="button">
              <div className="tooltip tooltip-bottom hover:tooltip-open" data-tip="Menu">
                <SlMenu />
              </div>
            </div>
            <ul tabIndex={0} className="dropdown-content text-lg menu bg-base-100 rounded-box z-1 w-52 p-2 shadow-2xl border border-black/30">
              <li><a><MdOutlineHomeWork /> Company</a></li>
              <li><a><LuTabletSmartphone /> Product</a></li>
              <li><a><MdGroups /> Community</a></li>
              <li><a><FaRegFileAlt /> Legal</a></li>
              <li><a><MdTranslate /> English</a></li>
            </ul>
          </div>
      ...
      <div className="w-full overflow-x-auto whitespace-nowrap py-2 px-4 bg-base-100 shadow-md">
        <div className="inline-flex sm:gap-4 h-[1px]">
          ...
          <button className="btn btn-sm btn-ghost">Architecture & Interiors</button>
